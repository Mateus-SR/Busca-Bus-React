    ...
    return (
        <main className="flex min-h-screen w-full">
            <div className="bg-sptrans flex flex-col flex-1 items-center justify-center text-center p-16 max-w-1/2">
                <h1 className="font-extrabold text-3xl text-white mb-2 italic">
                    Ops! Essa página não foi encontrada.
                </h1>
                <p className="text-white font-bold mb-6">
                    O endereço que você tentou acessar não existe.
                    <br/>
                    Se está tentando acessar uma exibição, verifique o código inserido e tente novamente.
                </p>
                <Link
                    href="/"
                ...
                {/* <InfoCard titulo="Detalhes técnicos">
